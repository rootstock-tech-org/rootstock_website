...
export default function DiscoverSection() {
  ...
  return (
    <section ref={sectionRef} className="section section--divider divider-light bg-gradient-to-r from-[#0B3762]/10 via-[#16BAC5]/10 to-[#7AE582]/10">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
          ...
          <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl reveal">
            ...
            <div className="p-6 sm:p-8">
              ...
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                <li className="flex items-start gap-3 reveal"><span className="text-[#16BAC5] mt-1">•</span><span className="text-sm sm:text-base">Context-first AI that blends data, signals, and human factors</span></li>
                <li className="flex items-start gap-3 reveal"><span className="text-[#7AE582] mt-1">•</span><span className="text-sm sm:text-base">Transparent, ethical, and explainable outcomes</span></li>
              ...
              <div className="flex flex-col items-center gap-3">
                <a href="#about" className="btn btn-primary animate-pulse-glow text-sm sm:text-base">Learn More</a>
                <a href="#demo" className="btn btn-text text-sm sm:text-base">See a 30-sec Demo</a>
              </div>
            </div>
          </div>
          ...
          <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl reveal">
            ...
            <div className="p-6 sm:p-8">
              ...
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                <li className="flex items-start gap-3 reveal"><span className="text-[#16BAC5] mt-1">•</span><span className="text-sm sm:text-base">WhatsApp + Web companion, 24×7</span></li>
                <li className="flex items-start gap-3 reveal"><span className="text-[#7AE582] mt-1">•</span><span className="text-sm sm:text-base">Actionable summaries from complex reports</span></li>
              ...
              <div className="flex flex-col items-center gap-3">
                <a href="#FinSight" className="btn btn-secondary animate-pulse-glow text-sm sm:text-base">Learn More</a>
                <a href="#demo" className="btn btn-text text-sm sm:text-base">See a 30-sec Demo</a>
              </div>
            </div>
          </div>
