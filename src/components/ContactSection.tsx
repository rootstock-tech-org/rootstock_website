            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <p className="flex items-start text-gray-700">
                  <svg className="w-6 h-6 mr-3 text-primary flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                  </svg>
                  <span className="flex flex-col">
                    <span>IIITD Innovation and Incubation Center</span>
                    <span>535 , 5th Floor Okhla Industrial Estate , Phase-III</span>
                    <span>New Delhi-110020</span>
                  </span>
                </p>
              </div>
            </div>
