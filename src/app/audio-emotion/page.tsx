export default function AudioEmotionPage() {
  return (
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-gray-700 mt-4 max-w-3xl mx-auto">
              Decode emotions, intensity and tone from raw audio. Build empathetic agents, call analytics and wellbeing apps with high‑accuracy emotion inference.
            </p>
            ...
            {[
              {
                ...
                desc: 'Prosody, spectral and linguistic cues combined for robust inference across accents and noise.',
              },
              {
                title: 'Real‑time streaming API',
                desc: 'Low‑latency WebSocket for live calls and bots. Batched REST for offline processing.',
              },
              {
                title: 'Privacy & security first',
                desc: 'On-device and regional processing options; PII‑safe logs and enterprise controls.',
              },
            ].map((f, i) => (
      ...
      <section id="get-started" className="py-14">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="rounded-3xl bg-white p-8 md:p-12 border border-gray-200 shadow-lg flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900">Understand emotions from voice</h3>
